...
GO
CREATE NONCLUSTERED INDEX [IX_doc_nor_document_event_lookup] ON [dbo].[doc_nor_document_event] ([AttachmentId], [event_name], [utc_time])
GO
ALTER TABLE [dbo].[doc_nor_document_event] ADD CONSTRAINT [FK__doc_nor_d__doc_i__1B5E0D89] FOREIGN KEY ([AttachmentId]) REFERENCES [dbo].[doc_nor_document] ([AttachmentID]) ON DELETE CASCADE
GO
